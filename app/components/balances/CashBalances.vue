<template>
  <div class="space-y-4">
    <UModal
      ...
      :close="{ label: 'Готово', variant: 'ghost' }"
    >
      <div
        class="flex justify-between items-start p-4 hover:opacity-80 transition-opacity hover:bg-gray-800/30"
      >
        <div class="flex-1">
