<template>
  <div>
    <div class="flex justify-center">
      <div
        class="w-16 h-16 bg-gray-800 rounded-2xl flex items-center justify-center"
      >
    ...
    <div class="text-center space-y-2">
      ...
      <UInput
        ...
        size="xl"
        type="text"
        v-model="cash.balanceName"
      />
      <p class="text-xs text-gray-500">
        Доданий рахунок буде відображено в розділі «Рахунки та готівка», і ви в
        будь-який момент можете його змінити.
      </p>
    </div>
    <div class="grid grid-cols-2 gap-4">
      ...
      <div>
        ...
        <USelect :options="[{ label: 'UAH', value: 'uah' }]" size="lg" />
      </div>
    </div>
    <div class="space-y-4">
      <div class="flex items-start gap-3">
        ...
        <div class="flex-1">
          ...
          <p class="text-xs text-gray-500">
            Якщо вимкнути опцію, баланс рахунку буде враховуватись тільки в
            аналітиці, але не буде включений у загальний баланс.
          </p>
        </div>
      </div>
      <div class="flex items-start gap-3">
        ...
        <div class="flex-1">
          ...
          <p class="text-xs text-gray-500">
            Якщо ввімкнути опцію ваш рахунок буде відображатись в розділі
            "Збереження"
          </p>
        </div>
      </div>
      <div class="flex justify-center items-center">
        <UButton
          class="w-100"
          color="error"
          label="Видалити рахунок"
          @click="cashStore.removeSelectedBalance(cash.id as string)"
        />
      </div>
    </div>
  </div>
