    ...
    <template #body>
      <main>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <UCard
            class="rounded-3xl bg-[#1d1e22] overflow-y-scroll"
            v-if="cashStore.cashBalance.length"
          >
            ...
            <CashBalances
              v-for="cash in cashStore.cashBalance"
              :key="cash.id"
              :cash="cash"
            />
          </UCard>
...
import CashBalances from "~/components/balances/CashBalances.vue";
